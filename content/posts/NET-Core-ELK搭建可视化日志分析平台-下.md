...
description: 本文介绍了从 Logstash 到 Filebeat 到 Fluentd 的日志收集工具演进过程，重点讨论了各工具的特点、优缺点以及配置方法。详细说明了 Filebeat 的轻量级特性及配置方式，以及 Fluentd 和 Fluent-Bit 之间的对比和使用方法。同时介绍了 Tail 模式和 Forward 模式下的日志收集策略，以及配置文件示例和实际操作步骤。文章通过讲述作者的个人思考和体验，总结了日志收集工具的选择和使用建议。
---
