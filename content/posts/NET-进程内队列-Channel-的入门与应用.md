...
![FakeRPC 如何支持 WebSocket 协议](/posts/NET-进程内队列-Channel-的入门与应用/FakeRPC-WebSocket-Framework-Design.drawio.png)
...
![利用 Channel 实现数据流模式](/posts/NET-进程内队列-Channel-的入门与应用/Data-Pipelines-With-Channel.drawio.png)
