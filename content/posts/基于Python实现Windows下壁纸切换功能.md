...
description: 本文介绍了作者尝试改变博客写作风格的经历，强调了在写作中注重"为什么"而不只是"如何"的重要性。作者通过Python和Windows注册表实现了壁纸切换功能，涉及requests和pyinstaller模块的使用。初衷源于对壁纸的挑剔，通过从Pexels和Unsplash网站抓取图片来解决。详细介绍了代码实现和将功能整合到系统菜单中的过程。最终，通过修改注册表实现了右键菜单中的壁纸切换选项。提及了未来设计扩展的问题和计划。
slug: 2822230423
tags:
- Python
- 脚本
